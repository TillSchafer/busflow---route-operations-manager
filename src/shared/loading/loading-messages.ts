...
const SCOPED_LOADING_MESSAGES: Record<LoadingScope, Record<LoadingMessageKey, string>> = {
  ...
  action: {
    ...
    'action.dizpo.route.delete': 'Loesche Route...',
    'action.dizpo.bus_type.save': 'Speichere Bustyp...',
    'action.dizpo.bus_type.delete': 'Loesche Bustyp...',
    'action.dizpo.worker.save': 'Speichere Mitarbeiter...',
    'action.dizpo.worker.delete': 'Loesche Mitarbeiter...',
    'action.dizpo.contact.save': 'Speichere Kontakt...',
    'action.dizpo.contact.delete': 'Loesche Kontakt...',
    'action.dizpo.customer.import.preview': 'Pruefe CSV...',
    'action.dizpo.customer.import.commit': 'Importiere Kontakte...',
    'action.dizpo.customer.bulk_delete': 'Loesche Kontakte...',
    'action.dizpo.map_default.save': 'Speichere Karten-Standard...'
  },
  system: {
    'system.default': 'Lade...'
  }
