    ...
    <div className="p-8 max-w-[210mm] mx-auto bg-white text-black leading-snug text-[13px]">
      ...
      <table className="w-full border-collapse border-2 border-black mb-6 text-[12px]">
        <thead>
          <tr className="bg-slate-100 border-b-2 border-black">
            ...
            <th className="border-r-2 border-black px-2 py-2 text-center w-20">Soll Ank.</th>
            <th className="border-r-2 border-black px-2 py-2 text-center w-20">Soll Abf.</th>
        ...
        <tbody>
          {route.stops.map((stop, i) => (
            <tr key={stop.id} className="border-b border-slate-300 h-12">
              ...
              <td className="border-r-2 border-black px-2 py-1.5 text-center font-mono">{stop.actualArrivalTime || '____'}</td>
              <td className="border-r-2 border-black px-2 py-1.5 text-center font-mono">{stop.actualDepartureTime || '____'}</td>
      ...
      <div className="grid grid-cols-2 gap-8 mt-auto">
        ...
        <div className="flex flex-col justify-between items-end space-y-6">
          <div className="w-full border border-black rounded-md p-2 min-h-[120px]">
