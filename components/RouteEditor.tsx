    ...
    <div className="bg-white shadow-xl rounded-2xl overflow-hidden border border-slate-200">
      <div className="p-6 border-b border-slate-100 flex flex-col md:flex-row justify-between items-start md:items-center bg-slate-50 gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button 
            onClick={exportToCSV}
            className="p-2 text-slate-600 hover:text-indigo-600 hover:bg-indigo-50 transition-colors rounded-lg border border-slate-200 bg-white"
          ...
          <table className="w-full text-left text-sm">
            <thead className="bg-slate-50 text-slate-600 font-semibold border-b">
              <tr>
                ...
                <th className="px-4 py-3 w-28">Ist Ank.</th>
                <th className="px-4 py-3 w-28">Ist Abf.</th>
